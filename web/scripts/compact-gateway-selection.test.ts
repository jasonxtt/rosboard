...
import { gatewayCandidatesForWAN, suggestedGatewayForWAN } from '../src/compact/features/policy/gateway.ts'
import type { PolicyDiscovery } from '../src/compact/features/policy/canonical.ts'
