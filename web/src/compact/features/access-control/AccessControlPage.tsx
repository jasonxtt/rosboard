...
import { accessScheduleSummary, alwaysAccessSchedule, validateAccessSchedule } from '../../../features/policy/schedule'
import { AccessScheduleEditor } from '../../../features/policy/ui/AccessScheduleEditor'
...
function rulePayload(rule: AccessRule) { return { id: rule.id, name: rule.name, subject: rule.subject, targetScope: rule.targetScope, targetListIds: rule.targetListIds, schedule: rule.schedule, enabled: rule.enabled, revision: rule.revision } }
